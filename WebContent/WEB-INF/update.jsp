...
try
{
	...
	PreparedStatement ps =con.prepareStatement("SELECT * from student where id="+did);
...
<div class="modal fade " id="Modal3" tabindex="-1" aria-labelledby="ModalLabel3" aria-hidden="true">
  ...
  <div class="row">
        ...
        <input type="text" class="form-control" id="lname" name="lname" <%=set.getString("lname") %>">
        </div>
        <div class="col-xs-12">
...
<div class="form-check">
  ...
  <label class="form-check-label" for="gender2">
    Female
        ...
        <input type="number" class="form-control" id="contact_no" name="contact_no" value="<%=set.getString("contact_no") %>">
        </div>
        <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="cpass" name="cpass" value="<%=set.getString("password") %>">
        </div>
    </div>
  <br>
